...
specific arithmetic ration.  /!\ Only for PATIENTS data
"""
...
def CC_division(patient, division_fracs, Freesurfer_path, P_folder_path):
    ...
    wmparc = wmparc_load.get_fdata()
    
    wmparc_new = wmparc.copy()
    
    
    #print(np.max(wmparc_new))
...
patient = "sub12_E2" #sys.argv[1] 

division_fracs = [1/4, 1/3, 1/2, 5/6] #Specific ratio of the updated division
